...
/*
#cgo CFLAGS: -I${SRCDIR}
#cgo LDFLAGS: -L${SRCDIR} -lletus -lssl -lcrypto -lstdc++ -fPIE
#include "Letus.h"
#include <stdio.h>
#include <stdlib.h>
*/
...
func Open(config VidbConfigInterface, logger commonutils.Logger) (i.KVStorage, error) {
...
func (s *LetusKVStroage) NewBatch() (i.Batch, error) {
	return NewLetusBatch(s)
}

func (s *LetusKVStroage) NewBatchWithEngine() (i.Batch, error) {
	return NewLetusBatch(s)
}

func (s *LetusKVStroage) NewIterator(begin, end []byte) i.Iterator {
